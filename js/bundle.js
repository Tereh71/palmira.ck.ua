...
function cards() {
  ...
  Object(_servises_servises__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/menu')
    .then(data => {
      data.forEach(({
        img,
        altimg,
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", (e) => {
      ...
      Object(_servises_servises__WEBPACK_IMPORTED_MODULE_1__["postData"])("http://localhost:3000/requests", json)
        .then((data) => {
          console.log(data);
